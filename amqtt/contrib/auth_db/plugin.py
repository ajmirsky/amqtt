...
from amqtt.contrib.auth_db.models import AllowedTopic, Base, PasswordHasher
...
class AuthUserDBPlugin(BaseAuthPlugin, BaseTopicPlugin):
...
class AuthTopicDBPlugin(BaseTopicPlugin):
