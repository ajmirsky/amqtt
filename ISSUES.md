...
**Scope:**
- [x] Extend `PublishPacket` to encode/decode v5 Properties.
- [x] Handle zero-length topic name (alias path).

**Acceptance criteria:**
- [x] Round-trip test with: Payload Format Indicator, Message Expiry Interval, Response Topic, Content Type, User Properties.
- [x] Zero-length topic with Topic Alias encodes correctly.
